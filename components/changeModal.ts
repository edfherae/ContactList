...
export class ChangeModal {
    ...
    private modalOption : HTMLParagraphElement;
    private buttonClose : HTMLParagraphElement;
    private nameField : HTMLInputElement;
    private vacancyField : HTMLInputElement;
    private phoneNumberField : HTMLInputElement;
